...
public class SendTelMsgUtils {
	 ...
	 */
	public static final String ACCOUNT_SID = "51c11d4ddea83346e99348cd88dacda2";
 
 
	/**
	 * AUTH_TOKEN:开发者账号认证密匙(注册后自动生成)
	 */
	public static final String AUTH_TOKEN = "b8f0e51c958d32d78b4fb993e7dae187";
	...
	public static String sendMsgTo(String to, String createRandNum) {
		 ...
		 */
		String smsContent = "【捷润数码科技】您的验证码为："+randNum+"，请在"+5+"分钟内完成操作。";
